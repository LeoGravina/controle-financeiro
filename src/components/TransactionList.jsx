                        ...
                        return (
                            <li key={t.id} className={rowClass} style={{ borderLeftColor: categoryColor }}>
                                ...
                                >
                                    {t.type === 'expense' && (
                                        <div 
                                            className="paid-status-wrapper" 
                                            onClick={handleActionClick} 
                                            style={{ display: 'flex', alignItems: 'center' }}
                                        >
                                            <label 
                                                className="paid-status-toggle" 
                                                aria-label={t.isPaid ? "Marcar como não pago" : "Marcar como pago"}
                                            >
                                                <input 
                                                    type="checkbox" 
                                    ...
                                    <div className="transaction-details">
                                        <span>
                                            {t.isFixed && <FaThumbtack className="fixed-expense-icon" title="Despesa Fixa" />}
                                            {t.description}
                                        </span>
                                        <small>
